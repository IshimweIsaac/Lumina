...
# The filenames uploaded by GitHub Actions in release.yml:
# lumina-windows-x64.exe
# lumina-windows-x64.exe-lsp.exe
Download-Binary -Name "core" -UrlSuffix "windows-x64.exe" -BinName "lumina.exe"
Download-Binary -Name "lsp" -UrlSuffix "windows-x64.exe-lsp.exe" -BinName "lumina-lsp.exe"
