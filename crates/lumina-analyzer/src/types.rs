...
pub use lumina_parser::ast::{LuminaType, FieldMetadata};
...
impl Schema {
    ...
    pub fn register_field(&mut self, entity: &str, field_name: &str, ty: &LuminaType) {
        ...
        if !entity_schema.fields.contains_key(field_name) {
            ...
            entity_schema.field_indices.insert(field_name.to_string(), idx);
            entity_schema.fields.insert(field_name.to_string(), FieldSchema {
